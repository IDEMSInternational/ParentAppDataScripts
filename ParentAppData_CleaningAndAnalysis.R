...
#Check the working directory and source the personal setup
getwd()
source("Code/Personal Setup.R")
...
plhdata_org$Org <- plyr::revalue(x=plhdata_org$organisation_full, replace=c(`Miss.Miss` =  "Miss", `Nontobeko.Miss` = "Nontobeko", `Joy.Miss` = "Joy", `Dlalanathi.Miss` = "Dlalanathi", `Miss.baba` = "Other", `Miss.` = "Other", `Miss.w` = "Other", `Miss.idems` = "Other", `Miss.Hillcrest facilitator` = "Hillcrest", `Miss.hillcrest` = "Hillcrest", `Miss.aqujhk,jafvh` = "Other", `Miss.ParentApp_dev` = "Other", `Miss.CWBSA` = "Other", `Miss.c9097349f34b364c` = "Other", `Miss.null` = "Other", `Dlalanathi.null` = "Dlalanathi", `Nontobeko.Nontobeko M` = "Nontobeko", `Nontobeko.bbe9ca70c78f7384` = "Nontobeko", `Miss.My NGO` = "Other", `Miss.idems Margherita` = "Other", `Miss.NontobekoM` = "Nontobeko", `Nontobeko.NontobekoM` = "Nontobeko", `Miss.dlanathiThandeka` = "Dlalanathi", `Miss.dlalanathiThandeka` = "Dlalanathi", `Miss.dlalanathi` = "Dlalanathi", `Miss.Hillcrest Facilitator ` = "Hillcrest", `Miss.JK test` = "Other", `Miss.Hillcrest Facilitator` = "Hillcrest", `Miss.IDEMS Ohad` = "Other", `Nontobeko.nontobekoM` = "Nontobeko"))
...
plhdata_org_clean <- filter(plhdata_org_clean, !is.na(plhdata_org_clean$'App Version'))
...
sjPlot::sjtab(data=plhdata_org_clean, Org, 'App Version', show.summary=FALSE, digits=0, fun="xtab", title="", string.total="Total")

# Show the summary of app versions, self care workshop completion
...
sjPlot::sjtab(data=plhdata_org_clean, Org, rp.contact.field.survey_completed , show.summary=FALSE, digits=0, fun="xtab", title="", string.total="Total")
...
plhdata_org_NONTOBEKOM <- filter(plhdata_org, Org == "Nontobeko")

# Show any app user ids that are invalid and do not come from the app.
plhdata_org_NONTOBEKOM %>% filter(is.na(plhdata_org_NONTOBEKOM$'App Version')) %>% select('App User ID')

# Create subsets of the data based on valid NONTOBEKOM app user ID's
plhdata_org_NONTOBEKOM <- filter(plhdata_org_NONTOBEKOM, !is.na(plhdata_org_NONTOBEKOM$'App Version'))

# Show the summary of app versions
sjmisc::frq(x=plhdata_org_NONTOBEKOM$'App Version', out="txt")

#####Completion rate of introductory session(Workshop 1:Selfcare)####
# Show the summary of self care completion
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.w_self_care_completed, out="txt")

# Show app user ids and whether they have completed selfcare.
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.w_self_care_completed")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.survey_completed, out="txt")

# Show app user ids and whether they have completed the baseline survey.
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.survey_completed")

# Show the summary of baseline survey completion(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.survey_completed, out="txt")

# Show app user ids and whether they have completed the baseline survey
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.survey_completed")


# Show the summary of baseline survey completion(HILLCREST)
sjmisc::frq(x=plhdata_org_HILLCREST$rp.contact.field.survey_completed, out="txt")

# Show app user ids and whether they have completed the baseline survey
plhdata_org_HILLCREST %>%  select('App User ID', "rp.contact.field.survey_completed")

# Show the summary of baseline survey completion(DLALANATHI)
sjmisc::frq(x=plhdata_org_DLALANATHI$rp.contact.field.survey_completed, out="txt")

# Show app user ids and whether they have completed the baseline survey
plhdata_org_DLALANATHI %>%  select('App User ID', "rp.contact.field.survey_completed")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.survey_welcome_a_1_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_1
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.survey_welcome_a_1_final")


# Show the summary of survey_welcome_a_1(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.survey_welcome_a_1_final, out="txt")

# Show app user ids and their responses to  survey_welcome_a_1
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.survey_welcome_a_1_final")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.survey_welcome_a_2_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_2_final
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.survey_welcome_a_2_final")

# Show the summary of survey_welcome_a_2_final(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.survey_welcome_a_2_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_2_final
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.survey_welcome_a_2_final")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.survey_welcome_a_3_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_3_final
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.survey_final_a_3_final")

# Show the summary of survey_welcome_a_3_final(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.survey_welcome_a_3_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_3_final
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.survey_welcome_a_3_final")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.survey_welcome_a_4_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_4_final
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.survey_welcome_a_4_final")

# Show the summary of survey_welcome_a_4_final(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.survey_welcome_a_4_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_4_final
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.survey_welcome_a_4_final")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.survey_welcome_a_5_part_1_final, out="txt")
...
# Show app user ids and their responses to survey_welcome_a_5_part_1_final
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.survey_welcome_a_5_part_1_final")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.survey_welcome_a_5_part_2_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_5_part_2_final
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.survey_welcome_a_5_part_2_final")

# Show the summary of survey_welcome_a_5_part_2_final(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.survey_welcome_a_5_part_2_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_5_part_2_final
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.survey_welcome_a_5_part_2_final")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.survey_welcome_a_6_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_6_final
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.survey_welcome_a_6_final")

# Show the summary of survey_welcome_a_6_final(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.survey_welcome_a_6_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_6_final
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.survey_welcome_a_6_final")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.survey_welcome_a_7_part_1_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_7_part_1_final
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.survey_welcome_a_7_part_1_final")

# Show the summary of survey_welcome_a_7_part_1_final(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.survey_welcome_a_7_part_1_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_7_part_1_final
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.survey_welcome_a_7_part_1_final")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.survey_welcome_a_7_part_2_final, out="txt")

# Show app user ids and their responses to rp.contact.field.survey_welcome_a_7_part_2_final
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.survey_welcome_a_7_part_2_final")

# Show the summary of survey_welcome_a_7_part_2_final(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.survey_welcome_a_7_part_2_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_7_part_2_final
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.survey_welcome_a_7_part_2_final")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.survey_welcome_a_7_part_3_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_7_part_3_final
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.survey_welcome_a_7_part_3_final")

# Show the summary of survey_welcome_a_7_part_3_final(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.survey_welcome_a_7_part_3_final, out="txt")

# Show app user ids and their responses torp.contact.field.survey_welcome_a_7_part_3_final
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.survey_welcome_a_7_part_3_final")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.survey_welcome_a_8_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_8_final
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.survey_welcome_a_8_final")

# Show the summary of survey_welcome_a_8_final(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.survey_welcome_a_8_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_8_final
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.survey_welcome_a_8_final")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.survey_welcome_a_9_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_9_final
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.survey_welcome_a_9_final")

# Show the summary of survey_welcome_a_9_final(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.survey_welcome_a_9_final, out="txt")

# Show app user ids and their responses to survey_welcome_a_9_final
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.survey_welcome_a_9_final")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.user_gender, out="txt")

# Show app user ids and their user gender
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.user_gender")

# Show the summary of user_gender(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.user_gender, out="txt")

# Show app user ids and user_gender
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.user_gender")
...
sjmisc::frq(x=plhdata_org_NONTOBEKOM$rp.contact.field.user_age, out="txt")

# Show app user ids and their user age
plhdata_org_NONTOBEKOM %>%  select('App User ID', "rp.contact.field.user_age")

# Show the summary of user age(JOYN)
sjmisc::frq(x=plhdata_org_JOYN$rp.contact.field.user_age, out="txt")

# Show app user ids and user age
plhdata_org_JOYN %>%  select('App User ID', "rp.contact.field.user_age")
