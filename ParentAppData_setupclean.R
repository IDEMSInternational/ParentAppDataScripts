...
plhdata_org$Org <- plyr::revalue(x=plhdata_org$organisation_full, replace=c(`Miss.Miss` =  "Other", `Nontobeko.Miss` = "Nontobeko", `Joy.Miss` = "Joy", `Dlalanathi.Miss` = "Dlalanathi", `Miss.baba` = "Other", `Miss.w` = "Other", `Miss.idems` = "Other", `Miss.Hillcrest facilitator` = "Other", `Miss.hillcrest` = "Other", `Miss.aqujhk,jafvh` = "Other", `Miss.ParentApp_dev` = "Other", `Miss.CWBSA` = "Other", `Dlalanathi.null` = "Dlalanathi", `Nontobeko.Nontobeko M` = "Nontobeko", `Nontobeko.bbe9ca70c78f7384` = "Nontobeko", `Miss.idems Margherita` = "Other",  `Nontobeko.NontobekoM` = "Nontobeko", `Miss.dlalanathiThandeka` = "Dlalanathi", `Miss.Hillcrest Facilitator ` = "Other", `Miss.Hillcrest Facilitator` = "Other", `Miss.IDEMS Ohad` = "Other", `Nontobeko.nontobekoM` = "Nontobeko",`Miss.Research team `="Other",`Miss.983aba50330cf24c` ="Other", `Miss.sdfds`="Other", `Joy.c9097349f34b364c` ="Joy", `Nontobeko.null` ="Nontobeko", `Joy.null` ="Joy", `Miss.friend` ="Other", `Miss.myself` ="Other", `Miss.undefined` ="Other", `Miss.other` ="Other", `Amathuba Collective.Miss` ="Amathuba", `Dlalanathi.dlanathiThandeka` ="Dlalanathi", `Dlalanathi.dlalanathThandeka` ="Dlalanathi", `Dlalanathi.dlalanathiThandeka` ="Dlalanathi", `Dlalanathi.dlalanathi` ="Dlalanathi", `Dlalanathi.dlalanithi Thandeka` ="Dlalanathi", `Miss.zlto` ="Other", `Miss.hpccc` ="Other", `Miss.Amathuba Mzi` ="Amathuba", `Miss.Amathuba Mzi ` ="Amathuba", `Miss.seven_passes` ="Other", `Miss.amathuba` ="Amathuba"))
